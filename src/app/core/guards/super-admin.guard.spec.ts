...
describe('superAdminGuard', () => {
  ...
  const run = () => TestBed.runInInjectionContext(() => superAdminGuard(route, state));
  ...
  it('autorise uniquement le super-administrateur', () => {
    currentUser.set(makeUser(['ROLE_USER', 'ROLE_SUPER_ADMIN']));
    expect(run()).toBeTrue();
  });

  it('refuse un administrateur simple (création de comptes à privilèges)', () => {
  ...
  it('refuse un visiteur non connecté sans lever d’erreur', () => {
