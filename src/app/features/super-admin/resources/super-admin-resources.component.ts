...
@Component({
  selector: 'app-super-admin-resources',
  standalone: true,
  imports: [RouterLink, CommonModule, FormsModule],
  templateUrl: './super-admin-resources.component.html',
  styleUrl:    './super-admin-resources.component.scss'
})
export class SuperAdminResourcesComponent implements OnInit {
